...
const CardUsuario = (props: CardUsuarioProps) => {
   return (
      <div className="border bg-brancoEscurecido border-gray-700 rounded-md shadow-[4px_4px_4px_rgba(0,0,0,0.2)]  relative
         py-2 px-2 flex gap-3 w-full max-w-full
         lg:py-4 lg:px-4 lg:rounded-lg
         2xl:rounded-xl">
         
         <div className="absolute top-[-10px] right-[-10px] bg-havprincipal  p-1 rounded-full">
