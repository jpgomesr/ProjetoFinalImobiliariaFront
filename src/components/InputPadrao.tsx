...
const InputPadrao = ({label, htmlFor,mensagemErro, ...props}: InputPadraoProps) => {
   return (
      <div className="flex flex-col lg:gap-1 2xl:gap-2">
        ...
        >
         ...
         <input
            {...props}
            className={`h-6 rounded-md border py-2 px-2 ${mensagemErro ? "border-red-500" : "border-black text-[10px]" } focus:border-black
            md:h-8 md:text-sm
