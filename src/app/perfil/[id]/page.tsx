...
>
  ...
  <div className="w-full xl:w-1/4 flex flex-col items-center order-first xl:order-none xl:mt-10 xl:pl-5">
      ...
      <Controller
        ...
        render={({ field }) => (
          <>
            ...
            >
              <FaPencilAlt size={12} className="sm:size-[14px]" />
            </button>
            <input
              type="file"
              ref={fileInputRef}
  ...
  <div className="w-full sm:w-[90%] md:w-[95%] xl:w-[600px] flex flex-col gap-4 order-last xl:order-none">
    <div className="flex flex-col gap-4">
      ...
      <div className="col-span-2">
        <div className="relative">
          ...
          <div className="absolute right-1 top-[28px] sm:top-[30px] pointer-events-none">
            <svg
      ...
      <div className="col-span-2 flex flex-col gap-2">
        ...
        <div className="w-full min-h-[160px] sm:min-h-[180px] md:min-h-[200px] bg-white border border-gray-300 rounded-md p-3 sm:p-4 md:p-5 flex flex-col items-center justify-between">
          <div className="flex flex-col items-center gap-2 sm:gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gray-300 rounded-full flex items-center justify-center">
              <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-havprincipal" />
            </div>
            <span className="text-sm sm:text-base font-medium text-center">
              Autenticação Via E-mail
            </span>
            <p className="w-40 sm:w-48 text-xs sm:text-sm text-gray-500 text-center px-2">
              Use o código de segurança enviado para o seu e-mail como a sua autenticação de dois fatores (2FA).
            </p>
          </div>
          <button
            type="button"
      ...
      <div className="col-span-2 flex flex-col gap-2">
        <div className="w-full min-h-[160px] sm:min-h-[180px] md:min-h-[200px] bg-white border border-gray-300 rounded-md p-3 sm:p-4 md:p-5 flex flex-col items-center justify-between">
          <div className="flex flex-col items-center gap-2 sm:gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gray-300 rounded-full flex items-center justify-center">
              <MessageSquare className="w-5 h-5 sm:w-6 sm:h-6 text-havprincipal" />
            </div>
            <span className="text-sm sm:text-base font-medium text-center">
              Autenticação Via SMS
            </span>
            <p className="w-40 sm:w-48 text-xs sm:text-sm text-gray-500 text-center px-2">
              Use o seu número de telefone como o seu código de autenticação de dois fatores (2FA).
            </p>
          </div>
          <button
            type="button"
