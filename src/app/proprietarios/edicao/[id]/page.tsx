...
const Page = () => {
   ...
   const [proprietario, setProprietario] = useState<ModelProprietario | null>(
      null
   );
   ...
   useEffect(() => {
      const buscarProprietario = async () => {
         ...
         try {
            ...
            setValue(
               "tipoResidencia",
               proprietarioRequisicao.endereco.tipoResidencia
            );
            setValue(
               "numeroCasaPredio",
               proprietarioRequisicao.endereco.numeroCasaPredio
            );
            setValue(
               "numeroApartamento",
               proprietarioRequisicao.endereco.numeroApartamento
            );
