...
export default function RelatorioClient({
   ...
   const dadosPrecosVenda = {
      labels: graficosData.finalidades.imoveisVenda.map(
      ...
      datasets: [
         {
            ...
            backgroundColor: graficosData.finalidades.imoveisVenda.map(
               (imovel) =>
                  calcularCorPorPreco(
   ...
   const dadosPrecosAluguel = {
      labels: graficosData.finalidades.imoveisAluguel.map(
         (imovel) => imovel.titulo
      ),
      datasets: [
         {
            ...
            backgroundColor: graficosData.finalidades.imoveisAluguel.map(
               (imovel) =>
                  calcularCorPorPreco(
                     imovel.precoPromocional || imovel.preco || 0,
                     precoMaximoAluguel
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto w-full mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow text-center">
               ...
               <p className="text-3xl font-bold text-havprincipal">
                  {formatarPreco(
                     calcularMediaPrecos(
                        graficosData.finalidades.imoveisAluguel
                     )
                  )}
               </p>
            </div>
               ...
               >
                  <div className="px-4 py-3 md:px-6 md:py-4 flex items-center gap-3 md:gap-6">
                     ...
                     <div className="flex-1 text-right">
                        <span className="text-gray-700 text-base md:text-lg">
                           Agendamentos:{" "}
                           {initialData.agendamentosPorCorretor[
                              corretor.nome
                           ] || 0}
                        </span>
                     </div>
