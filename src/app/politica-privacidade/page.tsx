   ...
   return (
      <Layout className="text-xl lg:text-2xl text-havprincipal py-8 flex flex-col gap-6 font-medium pl-4 sm:pl-8 md:pl-12 lg:px-16 xl:px-20 pr-7">
         ...
         <div className="flex flex-col gap-4">
            <p>
               A sua privacidade é importante para nós. É política do Hav
               Imobiliária respeitar a sua privacidade em relação a qualquer
               informação sua que possamos coletar no site Hav Imobiliária, e
            ...
            <p>
               As imagens exibidas neste site são de domínio público, ou seja,
               podem ser utilizadas livremente sem restrições de direitos
               autorais.
            </p>
         </div>

         <div className="flex flex-col gap-4">
            <h2 className="text-3xl font-bold">Compromisso do Usuário</h2>
            <p>
               O usuário se compromete a fazer uso adequado dos conteúdos e da
               informação que o Hav Imobiliária oferece no site e com caráter
            ...
            <ul className="list-disc pl-7">
               ...
               <li>
                  ...
                  (softwares) do Hav Imobiliária, de seus fornecedores ou
         ...
         <div className="flex flex-col gap-4">
            ...
            <p>
               ...
               interaja com um dos recursos que você usa em nosso site. Esta
            </p>
         </div>
         <p>política é efetiva a partir de 13 March 2025 23:37</p>
      </Layout>
   );
};
