...
export default function MeusHorarios() {
   ...
   const [idHorarioParaExcluir, setIdHorarioParaExcluir] = useState<number | null>(null);
   const { id } = useParams();
   ...
   const handleSubmit = async () => {
      ...
      try {
         const response = await fetch(
            `${process.env.NEXT_PUBLIC_BASE_URL}/horarios/corretor`,
            {
               method: "POST",
               headers: {
   ...
   const confirmarDelecao = async () => {
      try {
         const response = await fetch(
            `${process.env.NEXT_PUBLIC_BASE_URL}/horarios/corretor/${idHorarioParaExcluir}`,
            {
               method: "DELETE",
            }
         );
